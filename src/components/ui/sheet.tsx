 ...
 * Based on Radix UI Dialog with custom animations
 */
...
const sheetVariants = {
  ...
  top: "inset-x-0 top-0 w-full h-3/4 sm:max-h-[85vh] data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
  bottom: "inset-x-0 bottom-0 w-full h-3/4 sm:max-h-[85vh] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
};
